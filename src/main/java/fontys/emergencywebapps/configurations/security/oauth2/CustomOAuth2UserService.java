...
import fontys.emergencywebapps.configurations.security.oauth2.userinfo.OAuth2UserInfo;
import fontys.emergencywebapps.configurations.security.oauth2.userinfo.OAuth2UserInfoFactory;
...
import fontys.emergencywebapps.configurations.security.UserPrincipal;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        roles.add(UserRoles.builder().role(Role.USER).build());
        user.setRoles(roles);
